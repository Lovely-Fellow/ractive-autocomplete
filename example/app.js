...
},{"../index.js":2,"ractive":4}],2:[function(require,module,exports){
module.exports = require("./lib/autocomplete.js");

},{"./lib/autocomplete.js":3}],3:[function(require,module,exports){
var Ractive = require("ractive");
...
var template
	...
	+	'<input value="{{_state.text}}" on-blur="blur" on-focus="show(true)" on-click="show(true)" on-keydown="keydown" {{#if placeholder}}placeholder="{{placeholder}}"{{/if}}>'
	+		'{{#if _state.visible}}'
